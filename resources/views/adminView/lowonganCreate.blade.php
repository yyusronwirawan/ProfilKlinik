...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Create Lowongan</li>
        </ol>
    </nav>
</div>
<div class="col-lg-8">
    <form method="POST" action="/dashboard/lowongan">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="Date" class="form-control @error('periode_akhir') is-invalid @enderror" name="periode_akhir" id="periode_akhir" value="{{old('periode_akhir')}}" autofocus>
            @error('periode_akhir')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
