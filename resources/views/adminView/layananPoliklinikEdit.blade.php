...
<form method="POST" action="/dashboard/layanan-poliklinik/{{$poli->slug}}">
    @method('put')
    @csrf
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('poliklinik') is-invalid @enderror" name="poliklinik" id="poliklinik" value="{{old('poliklinik',$poli->poliklinik)}}" autofocus>
                @error('poliklinik')
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug" value="{{old('slug',$poli->slug)}}">
                @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col mb-3 mt-3">
                ...
                <input id="ket" type="hidden" name="ket" value="{{old('ket',$poli->ket)}}">
